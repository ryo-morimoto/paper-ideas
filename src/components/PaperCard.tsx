...
export default function PaperCard({ paper: p, isOpen, onToggle }: Props) {
  return (
    <div
      ...
      className="cursor-pointer rounded-xl border bg-white px-4 py-[14px] transition-all focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none"
      style={{
        borderColor: isOpen ? p.color + "55" : "#e4e4e7",
        boxShadow: isOpen
          ? `0 4px 20px ${p.color}12`
    ...
    >
      ...
      <div className="flex items-start gap-[10px]">
        ...
        <div className="min-w-0 flex-1">
          <div className="text-sm font-bold leading-[1.45] text-zinc-900">
            <span className="mr-1.5 text-[11px] font-normal text-zinc-300">
              #{p.id}
            </span>
            {p.title}
            {p.github && (
      ...
      <p className="mt-[10px] text-[13px] leading-[1.7] text-zinc-600">
        {p.summary}
      </p>
