...
import { papers, categories, categoryCounts, categoryColorMap } from "../data/papers";
		...
		<main className="mx-auto min-h-screen max-w-[920px] bg-stone-50 px-4 py-6 font-sans">
			...
			<div className="mb-6">
				...
				<p className="mt-1.5 text-[13px] leading-relaxed text-zinc-500">
					50本 × 専門用語なし × 各3つの社会実装アイデア（根本価値からの演繹）× 論文URL付き
				</p>
			</div>
			...
			{/* Empty state */}
			{filtered.length === 0 && (
				<div className="py-10 text-center text-sm text-zinc-400">該当する論文がありません</div>
			)}
		</main>
	);
}
